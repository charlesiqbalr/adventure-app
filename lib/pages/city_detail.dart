          ...
          children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage(cityDetail.image),
                        fit: BoxFit.cover,
                      ),
                      boxShadow: [
                        BoxShadow(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    cityDetail.name, //Menampilkan Nama kota
                    style: TextStyle(
                      fontSize: 20,
                  ...
                  SizedBox(height: 5),
                  Text(
                    cityDetail.description, //Menampilkan Deskripsi kota
                    style: TextStyle(
                      fontSize: 15,
                    ),
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 5),
                      Text(
                        cityDetail.location, //Menampilkan Lokasi kota
                        style: TextStyle(
                          fontSize: 16,
                        ),
                      ),
