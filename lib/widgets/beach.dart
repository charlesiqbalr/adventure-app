    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          final beach = BeachPlaces[index]; // Ambil objek tempat
          return SizedBox(
            width: 220,
            child: Card(
              elevation: 0.4,
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            beach.name, // Tampilkan Nama Gunung Yang Sesuai
                            style: TextStyle(
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            beach.location, // Tampilkan lokasi yang sesuai
                            style: TextStyle(
                              fontSize: 13,
                            ),
                          )
